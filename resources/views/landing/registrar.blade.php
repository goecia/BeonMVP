<!-- Workaround for logued user -->
@if (Auth::user())
    <script>window.location = "/cilindro";</script>
@endif
            ...
            <div class="container">
                <div class="section landing-section">
                    <div id="formulario" class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="text-center title">¿Te quedaste con ganas de m&aacute;s?
                            <h4 class="text-center description">Registrate de forma r&aacute;pida para disfrutar de "El cilindro”
                    ...
                    <div id="formulario-registrar" class="row hidden">
                        <div class="col-md-8 col-md-offset-2">
                            <h2 class="text-center title">Muchas gracias!</h2>
                            <h4 class="text-center description">Un email fu&eacute; enviado a tu casilla de correo para confirmar el registro.</h4>
                        </div>
                    </div>
                </div>
            </div>
